...
export const CareerLineOption = [
    { value: 'ambry', label: '橱柜事业线组' },
    { value: 'furniture', label: '家具事业线组' },
    { value: 'door', label: '木门事业线组' },
    { value: 'bathroom', label: '卫浴事业线组' },
];
...
const CreateForm = Form.create()(props => {
    ...
    return (
        ...
        >
            <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="基地名称">
            ...
            <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="基地编码">
                {form.getFieldDecorator('value', {
                    initialValue:
                        isNotBlank(modalRecord) && isNotBlank(modalRecord.value)
                            ? modalRecord.value
                            : '',
                    rules: [{ required: true, message: '请输入基地编码' }],
            ...
            {/* <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="所属事业线">
                {form.getFieldDecorator('label', {
                    ...
                    <Select style={{ width: 300 }}>
                        {isNotBlank(CareerLineOption) &&
                            CareerLineOption.map((item, index) => (
...
@Form.create()
class BaseManageComponent extends PureComponent {
    constructor(props) {
        super(props);
        ...
        return (
            <Form onSubmit={this.handleSearch} layout="inline">
                <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
                    <Col md={8} sm={24}>
                        <FormItem label="基地名称">
                            {getFieldDecorator('label')(<Input placeholder="请输入类型" />)}
                        </FormItem>
                    </Col>
                    <Col md={8} sm={24}>
                        <FormItem label="基地编码">
                            {getFieldDecorator('value')(<Input placeholder="请输入故障原因" />)}
                        </FormItem>
                    </Col>
                    <Col md={8} sm={24}>
    ...
    render() {
        const {
            loading,
            dictionaryL: { listdict, departmentList, departmentFailure , basemanage},
        } = this.props;
...
export default BaseManageComponent;
